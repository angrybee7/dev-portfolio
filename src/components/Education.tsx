          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
            <div className="p-8">
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {['Web Development', 'Data Structures & Algorithms', 'Blockchain Development', 'Software Engineering', 'Database Systems', 'UI/UX Design', 'Mobile App Development','Automation Tool Development'].map(course => (
                    <span 
                      key={course} 
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
                  ...
                  <li>Teaching Assistant for Blockchain Development courses</li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-indigo-50 dark:bg-indigo-900/10 p-6">
              <p className="text-gray-700 dark:text-gray-300 italic">
                "My time at Dakota State University provided me with a strong foundation in computer science and blockchain principles and 
